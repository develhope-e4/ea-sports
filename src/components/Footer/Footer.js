  ...
  return (
    <div className="footer">
      ...
      <div className="footerBlanco">
        <div className="latIzq">{/* <Image></Image> */}</div>
        ...
        <div className="infIzq">
          ...
          <a className="linkTextoFooterBlanco" href="https://www.ea.com/es-es">
            Sus preferencias de cookies
          </a>
          <p className="linkTextoFooterBlanco">© 2023 Electronic Arts Inc.</p>
        </div>
        <div className="infDer">{/* <Image></Image> */}</div>
      </div>
    </div>
  );
};
