        ...
        <Container className={styles.contenido}>
          ...
          <div className={styles.subContenido2}>
            ...
            <div clasname={styles.advertencias}>
              <img className={styles.logoAdvertencias} src={logoPegi} alt="Logo Pegi" />
              <img
          ...
          <div className={styles.subContenido4}>
            *El contenido adicional requiere una compra independiente y todas
            las actualizaciones del juego básico. Es posible que se necesite una
            cuenta de la plataforma correspondiente, conexión a Internet y una
            Cuenta EA. Se aplican restricciones de edad. Cláusula completa de
            incentivos de compra anticipada (inglés) (se publicará en la URL del
            pack de EA.com) **Esta oferta promocional finaliza el 18 de enero de
            2024. Válida para nuevas compras de Los Sims 4 Se Alquila Pack de
            Expansión (el "Producto") en la Tienda Origin (origin.com), EA app
            (www.ea.com/ea-app) o en las tiendas participantes. Canjea el código
            del Producto físico antes del 18 de enero de 2025 para recibir el
            contenido adicional. Para el Producto digital, el contenido
            adicional se obtendrá automáticamente. La oferta no tiene valor en
            efectivo ni se podrá sustituir, intercambiar ni vender por dinero,
            bienes o servicios. No se podrá combinar con otras ofertas ni
            tarjetas de prepago canjeables por el contenido aplicable a menos
            que EA lo autorice expresamente. Quien efectúe la compra se hará
            cargo de los impuestos de venta aplicables. Esta oferta será nula en
            los países donde esté prohibida, gravada o limitada por la
            legislación vigente. Se necesita Los Sims 4 con todas sus
            actualizaciones. Consulta los requisitos mínimos del sistema del
            pack para PC. Para jugar y acceder a las funciones online y al
            contenido adicional es necesario disponer de conexión a Internet y
            una Cuenta EA, aceptar el Acuerdo de usuario de EA (terms.ea.com/es)
            y la Política de privacidad y directiva de cookies
            (privacy.ea.com/es), registrarse con un código de producto de un
            solo uso y disponer de una cuenta de la plataforma correspondiente.
            Es posible que necesites instalar el Cliente de Origin
            (origin.com/download) o EA app (ea.com/ea-app) para el producto para
            PC. Se aplican restricciones de edad. Consulta
            o.ea.com/ea/child-access-es y la cuenta de la plataforma
            correspondiente para obtener más información. Las actualizaciones
            obligatorias del contenido pueden descargarse de manera automática,
            necesitar almacenamiento adicional, ocasionar gastos de uso de banda
            ancha y requerir una compra adicional para acceder. EA puede retirar
            las funciones online 30 días después de publicar un aviso en
            ea.com/es-es/service-updates. Consulta la información del producto
            final cuando esté disponible en ea.com/es-es/legal.
          </div>
        </Container>
      </Section>
